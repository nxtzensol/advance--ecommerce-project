...
<head>
  <meta charset="utf-8">
    ...
    <link rel="icon" href="{{ asset('backendbackend/images/favicon.ico') }}">
                            ...
                            @csrf
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input id="email" class="form-control pl-15 bg-transparent text-white plc-white" type="email" name="email" placeholder="Email">
									</div>
								</div>
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input id="password" class="form-control pl-15 bg-transparent text-white plc-white" type="password" name="password"  placeholder="Password">
									</div>
								</div>
								  <div class="row">
									<div class="col-6">
